    ...
    switch ($act) {
        ...
        case 'dangky':
            ...
            if (isset($dangky) && ($dangky)) {
                ...
                if (
                    ...
                    $tk_email = gettaikhoan_email($email);
                    $tk_sdt = gettaikhoan_sdt($sdt);

                    if ($tk_email) $thongbao = 'Đăng ký thất bại, Email đã tồn tại!';
                    else if ($tk_sdt) $thongbao = 'Đăng ký thất bại, Số điện thoại đã tồn tại!';
                    else {
        ...
        case 'user':
            ...
            if (isset($editAccount_submit) && ($editAccount_submit)) {
                ...
                $tk_email = gettaikhoan_email($emailedit);
                $tk_sdt = gettaikhoan_sdt($sdtedit);
                if ($tk_email && ($email != $emailedit)) $thongbao = 'Sửa thông tin thất bại, Email đã tồn tại!';
                else if ($tk_sdt && ($sdt != $sdtedit)) $thongbao = 'Sửa thông tin thất bại, Số điện thoại đã tồn tại!';
                else {
