...
<main class="form_dangky">
    <form action="" method="post" enctype="multipart/form-data" onsubmit="return kiemtraformdk()">
        <h2>Đăng ký</h2>
        <input name="tenkh" class="taikhoan-dk" type="text" placeholder="Tài khoản" onchange="kiemtraformdk()" minlength="2" maxlength="15">
        ...
        <input class="pass-dk" type="password" placeholder="Mật khẩu" onchange="kiemtraformdk()" minlength="6">
        <input name="matkhau" class="repass-dk" type="password" placeholder="Nhập lại mật khẩu" onchange="kiemtraformdk()" minlength="6">

        <section>
            <label>
                <span>Ngày sinh:</span>
                <input name="ngaysinh" class="ngaysinh-dk" type="date" min="1900-01-01" max="2008-01-01">
            </label>
